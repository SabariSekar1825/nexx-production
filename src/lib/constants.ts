...
export const features = [
  {
    ...
    description: "Easily manage and organize your contacts.",
    detail: "Keep track of all your client and partner information in one place.",
  },
  {
    title: "Website Building",
    description: "Create stunning websites with ease.",
    detail: "Use our drag-and-drop editor to build and customize your site.",
  },
  {
    title: "Agency Management",
    description: "Streamline your agency's operations.",
    detail: "Integrated tools for project management, client communication, and workflow automation.",
  },
  {
    title: "Pipeline Management",
    description: "Manage your sales and project pipelines effectively.",
    detail: "Track progress, identify bottlenecks, and close deals faster.",
  },
];
